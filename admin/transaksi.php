      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penjualan /</span> Data Transaksi</h4>
                              ...
                              <form action="transaksi_status.php" method="post">
                                ...
                                <select name="status" id="" class="form-select" onchange="form.submit()">
                                  ...
                                  <option <?php if ($i['invoice_status'] == "3") {
                                    ...
                                    Dikonfirmasi & Sedang Diproses</option>
                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#buktiPembayaran_<?php echo $i['invoice_id']; ?>">
                                    <i class="bx bx-dock-top me-1"></i> Bukti Pembayaran</a>
                                  <a class="dropdown-item" href="invoice.php?id=<?php echo $i['invoice_id']; ?>">
                                    <i class="bx bx-copy me-2"></i> Invoice</a>
                                </div>
                                <!-- Modal Bukti Pembayaran -->
                                <div class="modal fade" id="buktiPembayaran_<?php echo $i['invoice_id']; ?>" tabindex="-1"
                                  aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                          ...
                                          <div class="col mb-3">
                                            <center>
                                              ...
                                              if ($i['invoice_bukti'] == "") {
                                                ...
                                                ?>
                                                <img src="../gambar/bukti_pembayaran/<?php echo $i['invoice_bukti']; ?>"
                                                  alt="" style="width: 100%">
                                                <?php
                                              }
                                              ?>
