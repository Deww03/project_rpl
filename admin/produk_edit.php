              ...
              <form action="produk_update.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <input type="number" class="form-control" name="harga" required="required"
                        placeholder="Masukkan Harga .." value="<?php echo $d['produk_harga']; ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea name="keterangan" class="form-control textarea" required="required" style="resize: none"
                    rows="10"><?php echo $d['produk_keterangan']; ?></textarea>
                </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <input type="number" class="form-control" name="berat" required="required"
                        placeholder="Masukkan Berat .." value="<?php echo $d['produk_berat']; ?>">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <input type="number" class="form-control" name="jumlah" required="required"
                        placeholder="Masukkan Jumlah .." value="<?php echo $d['produk_jumlah']; ?>">
                    </div>
                  </div>
                </div>
