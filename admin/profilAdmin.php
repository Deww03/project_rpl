                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                          ...
                          if ($foto['admin_foto'] == "") {
                            ?>
                            <img src="../gambar/sistem/user.png" alt="user-avatar" class="d-block rounded" height="100"
                              width="100">
                          <?php } else { ?>
                            <img src="../gambar/user/<?php echo $foto['admin_foto'] ?>" alt="user-avatar"
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="username"
                              value="<?php echo $d['admin_username'] ?>" required="required"
