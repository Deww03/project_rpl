                  ...
                  <div class="card-body">
                    <div class="demo-inline-spacing">
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#tambahBarangModal">Tambah Barang</button>
                    </div>
                  </div>
                  <br>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="profilBarang.php?id=<?php echo $d['produk_id'] ?>"><i
                                      class="bx bx-edit-alt me-1"></i> Edit</a>
                                  <a class="dropdown-item" href="produk_hapus.php?id=<?php echo $d['produk_id'] ?>"><i
                ...
                <form action="produk_act.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" required="required"
