      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Data Admin</h4>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="profilAdmin.php?id=<?php echo $d['admin_id'] ?>"><i
                                      class="bx bx-edit-alt me-1"></i> Edit</a><?php if ($d['admin_id'] != 1) { ?>
                                    <a class="dropdown-item" href="admin_hapus.php?id=<?php echo $d['admin_id'] ?>"><i
                                        class="bx bx-trash me-2"></i> Delete</a><?php } ?>
                                </div>
                              </div>
                            </td>
                          </tr>
