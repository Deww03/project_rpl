...
<head>
  ...
  <title>Data Customer | Awan Indonesia</title>
                  ...
                  <div class="card-body">
                    <div class="demo-inline-spacing">
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#tambahCustomerModal">Tambah Customer</button>
                    </div>
                  </div>
                  <br>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="profilCustomer.php?id=<?php echo $d['customer_id'] ?>"><i
                                      class="bx bx-edit-alt me-1"></i> Edit</a>
                                  <a class="dropdown-item" href="customer_hapus.php?id=<?php echo $d['customer_id'] ?>"><i
