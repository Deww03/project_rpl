...
<head>
  ...
  <title>Profil Customer | Awan Indonesia</title>
          ...
          <form action="customer_update.php" method="post" enctype="multipart/form-data">
            ...
            while ($d = mysqli_fetch_array($data)) {
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Customer /</span> Profil Customer</h4>
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama" value="<?php echo $d['customer_nama'] ?>"
                              required="required" placeholder="Masukan Nama .." autofocus>
                            <input type="hidden" class="form-control" name="id" value="<?php echo $d['customer_id'] ?>"
                              required="required">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Email</label>
                            <input type="text" class="form-control" name="email"
                              value="<?php echo $d['customer_email'] ?>" required="required"
                              placeholder="Masukan Email ..">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Hp</label>
                            <input type="text" class="form-control" name="hp" value="<?php echo $d['customer_hp'] ?>"
                              required="required" placeholder="Masukan No Hp ..">
                          </div>
                          <div class="mb-3">
                            <label for="lastName" class="form-label">Alamat</label>
                            <input type="text" class="form-control" name="alamat"
                              value="<?php echo $d['customer_alamat'] ?>" required="required"
                              placeholder="Masukan Alamat ..">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Password</label>
                            <input type="password" class="form-control" name="password" min="5"
                              placeholder="Kosongkan Jika tidak ingin di ganti">
                          </div>
                        </div>
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" value="Simpan">Simpan</button>
                          <button type="submit" class="btn btn-outline-secondary" href="customer.php">Cancel</button>
                        </div>
            </form>
          </div>
          <?php
