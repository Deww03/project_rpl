                  ...
                  <table class="table table-hover">
                    ...
                    <div class="card-body">
                      <div class="demo-inline-spacing">
                        <a href="laporan_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> &nbsp PRINT</a>
                      </div>
                    </div>
