		...
		<div class="row">
			...
			<div id="main" class="col-md-12">
				...
				<form action="" method="get">
					<input type="hidden" value="<?php echo mysqli_real_escape_string($koneksi, $k['kategori_id']); ?>"
						name="id">
				...
				<div id="store">
					...
					<div class="row">
						...
						$result = mysqli_query($koneksi, "select * from produk,kategori where kategori_id='$kategori' and kategori_id=produk_kategori");
								...
								<div class="product product-single">
									...
									<div class="product-body">
										...
										<div class="product-btns">
											...
											<a class="primary-btn add-to-cart btn-block text-center"
												href="keranjang_masukkan.php?id=<?php echo $d['produk_id']; ?>&redirect=index"><i
													class="fa fa-shopping-cart"></i> Masukkan Keranjang</a>
										</div>
									</div>
								</div>
							</div>
							...
							<?php for ($i = 1; $i <= $pages; $i++) { ?>
								...
								<?php } else { ?>
									...
									if (isset($_GET['urutan']) && $_GET['urutan'] == "harga") {
										?>
										<li><a
												href="?id=<?php echo $kategori ?>&halaman=<?php echo $i; ?>&urutan=harga"><?php echo $i; ?></a>
										</li>
									<?php
									} else {
										?>
										<li><a href="?id=<?php echo $kategori ?>&halaman=<?php echo $i; ?>"><?php echo $i; ?></a>
										</li>
										<?php
									}
									?>
